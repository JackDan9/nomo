      ...
      if (index == 0) {
        ...
        if (this.children > 2) {
          this.pickerData.splice(
            2,
            1,
            this._getData(jsAddress[a1].children[0].children)
          ); //三级赋值
        }
        ...
        this.pickerData.splice(
          2,
          1,
          this._getData(jsAddress[this.valueSub[0]].children[a2].children)
        );
      } else if (index == 2) {
      }
    ...
    __init() {
      ...
      if (this.children > 2) {
        ...
        this.pickerData.push(
          this._getData(jsAddress[a1].children[a2].children)
        ); //三级赋值
